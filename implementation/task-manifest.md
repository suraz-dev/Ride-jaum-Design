...
| R10 | Trip Planner and route comparison | R4,R8 | solo/group, disabled Supercurvy, hazards, waypoints; implementation brief: `implementation/briefs/R10-trip-planner-route-comparison.md` |
