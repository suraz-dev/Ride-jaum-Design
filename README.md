...
The backend, geospatial, realtime, offline-pack, privacy and safety-service architecture is documented in the [System Design](docs/11-system-design.md), with its own [system build manifest](implementation/system-design-task-manifest.md), [master prompt](prompts/03-system-design-master-prompt.md), and [follow-up prompts](prompts/04-system-design-follow-up-meta-prompts.md).
